...
(function(){
  document.addEventListener('DOMContentLoaded', () => {
    ...
    const modeToggleStatus = document.getElementById('converterModeStatus');
    const modeToggleHint = document.getElementById('converterModeHint');
    ...
    function setConverterMode(offline) {
      ...
      if (modeToggleHint) {
        modeToggleHint.textContent = isOfflineMode
          ? 'Cambiar a modo en línea'
